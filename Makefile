...
DEFINES += CHAINID_UPCASE=\"XINFIN\" CHAINID_COINNAME=\"XDC\" CHAIN_KIND=CHAIN_KIND_ETHEREUM CHAIN_ID=50
...
APP_LOAD_PARAMS = --path $(DERPATH)
DEFINES += CHAINID_UPCASE=\"XINFIN\" CHAINID_COINNAME=\"XDC\" CHAIN_KIND=CHAIN_KIND_ETHEREUM CHAIN_ID=51
